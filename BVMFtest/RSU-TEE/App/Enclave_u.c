...
sgx_status_t MyStrCpy(sgx_enclave_id_t eid, char* DeStr, char* SoStr, size_t DeLen, size_t SoLen)
{
	sgx_status_t status;
	ms_MyStrCpy_t ms;
	ms.ms_DeStr = DeStr;
...
sgx_status_t MyAccum(sgx_enclave_id_t eid, size_t* retval, size_t start, size_t end)
{
	sgx_status_t status;
	ms_MyAccum_t ms;
	ms.ms_start = start;
...
sgx_status_t TeeCalGRAT(sgx_enclave_id_t eid, struct mTrsLt* mTLst, struct msgRtLt* msRf, struct gCarTrust* gCTrust, size_t DeLen, size_t SoLen, size_t gCLen, int n)
{
	sgx_status_t status;
	ms_TeeCalGRAT_t ms;
	ms.ms_mTLst = mTLst;
	ms.ms_msRf = msRf;
	ms.ms_gCTrust = gCTrust;
	ms.ms_DeLen = DeLen;
	ms.ms_SoLen = SoLen;
	ms.ms_gCLen = gCLen;
	ms.ms_n = n;
...
sgx_status_t TeeCalSEG(sgx_enclave_id_t eid, struct mTrsLt* mTLs, struct msgRtLt* msRL, struct gCarTrust* gCTrust, size_t DeLen, size_t SoLen, size_t gCLen, int nTLsn, int msRLn, int gCTrustn)
{
	sgx_status_t status;
	ms_TeeCalSEG_t ms;
	ms.ms_mTLs = mTLs;
